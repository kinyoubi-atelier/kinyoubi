 ...
 * back to the house vocabulary without changing their copy. The hairline
 * is rendered on a wrapping container so its opacity is independent of
 * the heading text contrast.
 */
